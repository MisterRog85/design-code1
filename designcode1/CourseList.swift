...
//  designcode1
//
//  Created by William Tomas on 05/08/2020.
    ...
    var body: some View {
        ZStack(alignment: .top) {
            ...
            VStack(alignment: .leading, spacing: 30.0) {
                Text("Ceci est un blabla de remplissage car je n'ai rien à copier coller pour mon appli c'est quand même dommage hein allé bisous")
